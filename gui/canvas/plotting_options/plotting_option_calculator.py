    ...
    def calculateDistortions(self):
        ...
        for index, faceAfter in enumerate(self.facesAfter):
            ...
            if index % 2000 == 0 and index > 0:
                log(
                    str(round(100 * index / len(self.facesAfter), 2))
                    + "% ("
                    + str(index)
                    + "/"
                    + str(len(self.facesAfter))
                    + ")"
                )
        ...
        log(
            str(self.option)
            + " avg dist rounded: "
            + str(round(self.totalDistortion, 4))
        )
